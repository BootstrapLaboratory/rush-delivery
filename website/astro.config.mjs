...
const base = process.env.PAGES_BASE_PATH ?? (isProjectPages ? `/${repositoryName}` : undefined);
const site = process.env.PAGES_SITE_URL ?? "https://bootstraplaboratory.github.io";
...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      editLink: {
        baseUrl: "https://github.com/BootstrapLaboratory/rush-delivery/edit/main/",
      },
